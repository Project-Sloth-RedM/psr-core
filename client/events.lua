...
RegisterNetEvent("PSRCore:Client:UseItem", function(item)
	PSRCore.Debug(
		string.format(
			"%s triggered PSRCore:Client:UseItem by ID %s with the following data. This event is deprecated due to exploitation, and will be removed soon. Check psr-inventory for the right use on this event.",
			GetInvokingResource(),
